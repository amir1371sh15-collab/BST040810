...
// Permission check will be added once login system is complete
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['delete_id'])) {
        ...
        if (empty(trim($_POST['role_name']))) {
            $result = ['success' => false, 'message' => 'نام نقش نمی‌تواند خالی باشد.'];
            $_SESSION['message_type'] = 'warning';
        } else {
            $data = ['RoleName' => trim($_POST['role_name'])];
    ...
    header("Location: " . BASE_URL . "modules/users/manage_roles.php");
    exit;
}
...
$items = find_all($pdo, "SELECT * FROM " . TABLE_NAME . " ORDER BY RoleName");
...
<div class="page-header d-flex justify-content-between align-items-center">
    <h1 class="h3 mb-0">مدیریت نقش‌ها</h1>
...
<div class="row">
    <div class="col-lg-4">
        <div class="card content-card">
            <div class="card-header"><h5 class="mb-0"><?php echo $editMode ? 'ویرایش نقش' : 'افزودن نقش جدید'; ?></h5></div>
            <div class="card-body">
                <form method="POST" action="manage_roles.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="role_name" name="role_name" value="<?php echo htmlspecialchars($itemToEdit['RoleName'] ?? ''); ?>" required>
                    </div>
                    ...
                    <?php if ($editMode): ?><a href="manage_roles.php" class="btn btn-secondary">لغو</a><?php endif; ?>
                </form>
            </div>
        </div>
    </div>
    <div class="col-lg-8">
        <div class="card content-card">
            <div class="card-header"><h5 class="mb-0">لیست نقش‌ها</h5></div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-striped table-hover mb-0">
                        <thead><tr><th class="p-3">#</th><th class="p-3">نام نقش</th><th class="p-3">عملیات</th></tr></thead>
                        <tbody>
                                ...
                                <td class="p-3">
                                    ...
                                    <div class="modal fade" id="deleteModal<?php echo $item[PRIMARY_KEY]; ?>" tabindex="-1">
                                      <div class="modal-dialog"><div class="modal-content">
                                        ...
                                        <div class="modal-body">آیا از حذف نقش "<?php echo htmlspecialchars($item['RoleName']); ?>" مطمئن هستید؟</div>
                                        <div class="modal-footer">
                                          <form method="POST" action="manage_roles.php" class="d-inline"><input type="hidden" name="delete_id" value="<?php echo $item[PRIMARY_KEY]; ?>"><button type="submit" class="btn btn-danger">بله، حذف کن</button></form>

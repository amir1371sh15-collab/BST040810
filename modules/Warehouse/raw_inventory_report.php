...
if (!has_permission('warehouse.raw.view')) { die('شما مجوز دسترسی به این صفحه را ندارید.'); }
...
$pageTitle = "گزارش گردش موجودی مواد اولیه";
        ...
        <form id="filter-form">
            <div class="row align-items-end">
                ...
                <div class="col-md-3 mb-3">
                 ...
                 <div class="col-md-3 mb-3">
                     <label for="category_id" class="form-label">دسته‌بندی ماده (اختیاری)</label>
    ...
    <div id="a4-wrapper">
        <div id="report-content" class="a4-page">
            <div id="report-header" class="mb-4 text-center">
                <h2 id="report-main-title" class="report-title-print">گزارش گردش موجودی مواد اولیه</h2>
...
$(document).ready(function() {
    const apiReportUrl = '<?php echo BASE_URL; ?>api/api_raw_get_inventory_report.php';
    ...
    categorySelect.on('change', function() {
        ...
        if (categoryId) {
            ...
            $.getJSON('<?php echo BASE_URL; ?>api/api_raw_get_items.php', { category_id: categoryId })
    ...
    $('#filter-form').on('submit', function(e) {
        ...
        if ($('#category_id').val()) {
            summary = `خانواده: ${$('#category_id option:selected').text()}`;

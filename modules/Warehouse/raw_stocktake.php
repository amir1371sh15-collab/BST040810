...
if (!has_permission('warehouse.raw.manage')) { die('شما مجوز انجام عملیات انبارگردانی را ندارید.'); }
...
$initial_log_date_jalali = $_SESSION['raw_stocktake_log_date'] ?? to_jalali(date('Y-m-d'));
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
    ...
    header("Location: " . BASE_URL . "modules/Warehouse/raw_stocktake.php?page=" . $redirect_page);
    exit;
}
    ...
    if ($edit_id) {
        ...
        if ($transaction && in_array((int)$transaction['TransactionTypeID'], $stocktake_type_ids, true)) {
            ...
            if (!$itemInfo) {
                ...
                $_SESSION['message_type'] = 'warning';
                header("Location: " . BASE_URL . "modules/Warehouse/raw_stocktake.php?page=" . $current_page);
                exit;
            }
            ...
            $_SESSION['raw_stocktake_log_date'] = $itemToEdit['TransactionDateJalali'];
...
$pageTitle = "انبارگردانی مواد اولیه";
...
<form id="stocktake-form">
    <div class="card content-card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <?php if ($editMode): ?>
                <a href="raw_stocktake.php?page=<?php echo $current_page; ?>" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" id="transaction_date" name="transaction_date" class="form-control persian-date persistent-input" data-session-key="raw_stocktake_log_date"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
          <form id="delete-form" method="POST" action="raw_stocktake.php?page=<?php echo $current_page; ?>" class="d-inline">
...
$(document).ready(function() {
    ...
    const apiGetInventoryUrl = '<?php echo BASE_URL; ?>api/api_raw_get_current_inventory.php';
    ...
    const stocktakePageUrl = 'raw_stocktake.php';
    ...
    transactionDateInput.on('change', function() {
        ...
        $.post('<?php echo BASE_URL; ?>api/api_update_session.php', { key: 'raw_stocktake_log_date', value: newDate });
    ...
    async function loadCurrentBalances(itemId, dateJalali) {
        ...
        try {
            ...
            console.error("Error fetching current raw balance:", error);

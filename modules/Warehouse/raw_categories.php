...
const TABLE_NAME = 'tbl_raw_categories';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: " . BASE_URL . "modules/Warehouse/raw_categories.php");
    exit;
}
...
$pageTitle = "مدیریت دسته‌بندی مواد اولیه";
...
<div class="row">
    <div class="col-lg-4">
        <div class="card content-card"><div class="card-header"><h5 class="mb-0"><?php echo $editMode ? 'ویرایش دسته‌بندی' : 'افزودن دسته‌بندی جدید'; ?></h5></div><div class="card-body">
            <form method="POST" action="raw_categories.php">
                ...
                <?php if ($editMode): ?><a href="raw_categories.php" class="btn btn-secondary">لغو</a><?php endif; ?>
            </form>
        </div></div>
    </div>
    <div class="col-lg-8">
                ...
                <td class="p-3">
                    ...
                    <div class="modal fade" id="deleteModal<?php echo $item[PRIMARY_KEY]; ?>" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form method="POST" action="raw_categories.php"><input type="hidden" name="delete_id" value="<?php echo $item[PRIMARY_KEY]; ?>"><button type="submit" class="btn btn-danger">بله</button></form>

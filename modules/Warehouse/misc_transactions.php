...
// استفاده از انواع تراکنش موجودی
...
$initial_log_date_jalali = $_SESSION['misc_transaction_date'] ?? to_jalali(date('Y-m-d'));
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
    ...
    header("Location: " . BASE_URL . "modules/Warehouse/misc_transactions.php?page=" . $redirect_page);
    exit;
}
    ...
    if ($edit_id) {
        ...
        if ($transaction && in_array((int)$transaction['TransactionTypeID'], $allowed_type_ids, true)) {
            ...
            if (!$itemInfo) {
                ...
                $_SESSION['message_type'] = 'warning';
                header("Location: " . BASE_URL . "modules/Warehouse/misc_transactions.php?page=" . $current_page);
                exit;
            }
            ...
            $_SESSION['misc_transaction_date'] = $itemToEdit['TransactionDateJalali'];
...
$pageTitle = "ثبت تراکنش مواد متفرقه";
...
<form id="transaction-form">
    <div class="card content-card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <?php if ($editMode): ?>
                <a href="misc_transactions.php?page=<?php echo $current_page; ?>" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" id="transaction_date" name="transaction_date" class="form-control persian-date persistent-input" data-session-key="misc_transaction_date"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
          <form id="delete-form" method="POST" action="misc_transactions.php?page=<?php echo $current_page; ?>" class="d-inline">
...
$(document).ready(function() {
    ...
    const stocktakePageUrl = 'misc_transactions.php';
    ...
    transactionDateInput.on('change', function() {
        ...
        $.post('<?php echo BASE_URL; ?>api/api_update_session.php', { key: 'misc_transaction_date', value: newDate });
    });

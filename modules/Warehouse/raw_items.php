...
const TABLE_NAME = 'tbl_raw_items';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: " . BASE_URL . "modules/Warehouse/raw_items.php?page=" . $current_page);
    exit;
}
...
$items_query = "SELECT mi.*, mc.CategoryName, u.Symbol as UnitSymbol
                FROM " . TABLE_NAME . " mi
                JOIN tbl_raw_categories mc ON mi.CategoryID = mc.CategoryID
...
$categories = find_all($pdo, "SELECT * FROM tbl_raw_categories ORDER BY CategoryName");
$units = find_all($pdo, "SELECT * FROM tbl_units ORDER BY UnitName");

$pageTitle = "مدیریت مواد اولیه";
...
<div class="row">
    <div class="col-lg-4">
        <div class="card content-card"><div class="card-header"><h5 class="mb-0"><?php echo $editMode ? 'ویرایش ماده' : 'افزودن ماده جدید'; ?></h5></div><div class="card-body">
            <form method="POST" action="raw_items.php?page=<?php echo $current_page; ?>">
                ...
                <?php if ($editMode): ?><a href="raw_items.php?page=<?php echo $current_page; ?>" class="btn btn-secondary">لغو</a><?php endif; ?>
            </form>
        </div></div>
    </div>
    <div class="col-lg-8">
        <div class="card content-card"><div class="card-header"><h5 class="mb-0">لیست مواد اولیه</h5></div><div class="card-body p-0"><div class="table-responsive"><table class="table table-striped table-hover table-sm mb-0">
                ...
                <td class="p-2 text-nowrap">
                    ...
                    <div class="modal fade" id="deleteModal<?php echo $item[PRIMARY_KEY]; ?>" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form method="POST" action="raw_items.php?page=<?php echo $current_page; ?>"><input type="hidden" name="delete_id" value="<?php echo $item[PRIMARY_KEY]; ?>"><button type="submit" class="btn btn-danger">بله</button></form>

...
const TABLE_NAME = 'tbl_task_statuses';
const PRIMARY_KEY = 'TaskStatusID';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: " . BASE_URL . "modules/engineering/task_statuses.php");
    exit;
}
...
$pageTitle = "مدیریت وضعیت‌های وظیفه";
include __DIR__ . '/../../templates/header.php';
?>

<div class="page-header d-flex justify-content-between align-items-center">
    <h1 class="h3 mb-0">مدیریت وضعیت‌های وظیفه</h1>
...
<div class="row">
    <div class="col-lg-4">
        <div class="card content-card">
            ...
            <div class="card-body">
                <form method="POST" action="task_statuses.php">
                    ...
                    <?php if ($editMode): ?><a href="task_statuses.php" class="btn btn-secondary">لغو</a><?php endif; ?>
                </form>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="modal fade" id="deleteModal<?php echo $item[PRIMARY_KEY]; ?>" tabindex="-1">
                                      <div class="modal-dialog"><div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                          <form method="POST" action="task_statuses.php" class="d-inline"><input type="hidden" name="delete_id" value="<?php echo $item[PRIMARY_KEY]; ?>"><button type="submit" class="btn btn-danger">بله، حذف کن</button></form>

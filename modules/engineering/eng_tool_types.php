...
const TABLE_NAME = 'tbl_eng_tool_types';
const PRIMARY_KEY = 'ToolTypeID';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['delete_id'])) {
        ...
        if (empty(trim($_POST['type_name']))) {
            $result = ['success' => false, 'message' => 'نام نوع ابزار نمی‌تواند خالی باشد.'];
    ...
    header("Location: " . BASE_URL . "modules/engineering/eng_tool_types.php");
    exit;
}
...
$items = find_all($pdo, "SELECT * FROM " . TABLE_NAME . " ORDER BY TypeName");

$pageTitle = "مدیریت انواع ابزار مهندسی";
include __DIR__ . '/../../templates/header.php';
?>

<div class="page-header d-flex justify-content-between align-items-center">
    <h1 class="h3 mb-0">مدیریت انواع ابزار مهندسی</h1>
...
<div class="row">
    <div class="col-lg-4">
        <div class="card content-card">
            <div class="card-header"><h5 class="mb-0"><?php echo $editMode ? 'ویرایش نوع ابزار' : 'افزودن نوع ابزار جدید'; ?></h5></div>
            <div class="card-body">
                <form method="POST" action="eng_tool_types.php">
                    <?php if ($editMode && $itemToEdit): ?>
                        <input type="hidden" name="id" value="<?php echo $itemToEdit[PRIMARY_KEY]; ?>">
                    <?php endif; ?>
                    <div class="mb-3">
                        <label for="type_name" class="form-label">نام نوع ابزار</label>
                    ...
                    <?php if ($editMode): ?><a href="eng_tool_types.php" class="btn btn-secondary">لغو</a><?php endif; ?>
                </form>
            </div>
        </div>
    </div>
    <div class="col-lg-8">
        <div class="card content-card">
            <div class="card-header"><h5 class="mb-0">لیست انواع ابزار</h5></div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-striped table-hover mb-0">
                        <thead><tr><th class="p-3">نام نوع ابزار</th><th class="p-3">عملیات</th></tr></thead>
                        <tbody>
                                    ...
                                    <div class="modal fade" id="deleteModal<?php echo $item[PRIMARY_KEY]; ?>" tabindex="-1">
                                      <div class="modal-dialog"><div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                          <form method="POST" action="eng_tool_types.php" class="d-inline"><input type="hidden" name="delete_id" value="<?php echo $item[PRIMARY_KEY]; ?>"><button type="submit" class="btn btn-danger">بله، حذف کن</button></form>
